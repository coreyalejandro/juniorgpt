...
class Artifact:
    ...
    def get_preview(self) -> Dict[str, Any]:
        """Generate preview of the artifact"""
...
class AdvancedArtifactManager:
    """
    Advanced artifact manager with Claude-4 level capabilities
...
# Convenience functions for the enhanced BaseAgent
def create_artifact_from_response(response_text: str, context: Dict[str, Any] = None) -> List[Dict[str, Any]]:
    """Create artifacts from agent response (for backward compatibility)"""
